...
## gnome-aesthetics (OPT-IN — profile `gnome-aesthetics`, NOT in full)
...
## gnome-theme (OPT-IN — profile `gnome-theme`, NOT in full)
...
- aesthetics: each UUID installed+enabled (opt-in), idempotent.
- theme: User Themes enabled; theme git-clone at the pinned tag + install.sh; papirus/bibata/inter
